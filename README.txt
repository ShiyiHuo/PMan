...
How to use PMan
Step 1: compile test files that you want to use first.
...
1. bg <cmd>: start program <cmd> in the background
	Example: If you want to run inf.c using bg, compile inf.c using "gcc inf.c -o inf" before you execute "./PMan". Compile and run PMan and input "bg ./inf a 1" where "a" and 1 are the parameters required by inf.c. Note that you should use ./inf if inf is not in PATH.
